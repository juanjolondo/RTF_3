...
public class PedidoClienteDTO extends VentaDTO {
	
	public PedidoClienteDTO(){
		
	}
	public PedidoClienteDTO(String idCliente, String descripcion, String medioPago, double precioTotal, boolean pagado,
