...
public class PedidoSuministrosDTO extends VentaDTO {
	
	public PedidoSuministrosDTO(){
		
	}
	public PedidoSuministrosDTO(String idCliente, String descripcion, String medioPago, double precioTotal, boolean pagado,
